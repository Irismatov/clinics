            ...
            <div class="hospitalization-recommendation">
                ...
                <c:if test="${diagnosis.agreedToHospitalization == null}">
                    <form method="post">
                        ...
                        <button type="submit" formaction="${pageContext.request.contextPath}/create-room/accept" class="btn btn-hospitalization">Принять госпитализацию</button>
                    </form>
                    <form method="post">
                        <input type="hidden" name="diagnosisId" value="${diagnosis.id}">
                        <input type="hidden" name="decision" value="reject">
                        <button type="submit" formaction="${pageContext.request.contextPath}/create-room/reject" class="btn btn-reject">Отклонить госпитализацию</button>
                    </form>
                </c:if>
            </div>
        </c:if>
